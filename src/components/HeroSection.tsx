...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-start justify-start overflow-hidden pt-20 md:pt-32">
      ...
      <div className="absolute top-20 left-4 md:left-10 w-3 h-3 md:w-4 md:h-4 bg-accent-purple rounded-full animate-float" style={{ animationDelay: '0s' }} />
      <div className="absolute top-32 right-4 md:right-20 md:top-40 w-4 h-4 md:w-6 md:h-6 bg-accent-aqua rounded-full animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-32 left-8 md:left-20 md:bottom-40 w-2 h-2 md:w-3 md:h-3 bg-accent-blush rounded-full animate-float" style={{ animationDelay: '4s' }} />

      <div ref={heroRef} className="w-full px-4 sm:px-6 md:px-12 lg:px-16 relative z-10 max-w-7xl mx-auto">
        <h1
          ref={titleRef}
          className="font-playfair text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-light text-heading mb-6 md:mb-8 leading-none tracking-[-0.06em]"
        >
          Hi !, I'm Kshitij
        </h1>
        ...
        <p
          ref={subtitleRef}
          className="font-playfair text-base sm:text-lg md:text-xl text-body max-w-none md:max-w-3xl leading-relaxed mb-6 md:mb-8 tracking-[-0.06em]"
        >
        ...
        <div
          ref={subtitleRef}
          className="font-playfair text-sm sm:text-base md:text-lg text-body max-w-none md:max-w-4xl leading-relaxed space-y-4 md:space-y-6 tracking-[-0.06em]"
        >
          <p>
        ...
        <div className="mt-12 md:mt-16 space-y-2 md:space-y-4 max-w-none md:max-w-4xl">
          {[
            ...
            <div
              key={award.name}
              className="flex items-center justify-between py-3 md:py-4 border-b border-gray-200 cursor-hover group"
            >
