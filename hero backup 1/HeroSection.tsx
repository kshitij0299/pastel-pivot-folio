      ...
      <div ref={heroRef} className="w-full px-4 sm:px-6 md:px-12 lg:px-16 relative z-10 max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="flex-1">
            <h1 className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-4 md:mb-6 leading-none tracking-wide text-white">
              <SplitText
                text="Hi !   I'm   Kshitij"
            ...
            <p ref={subtitleRef} className="font-playfair text-lg sm:text-xl md:text-2xl lg:text-3xl text-white max-w-4xl leading-[1.4] mb-[72px] md:mb-[96px] tracking-wide">
              a <GradientText
